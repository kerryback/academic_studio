...
<script>
  ...
  // latest GitHub release; otherwise mark it "under construction". Fail open —
  // if the API is unreachable or rate-limited, leave the plain links in place so
  // a working download is never hidden.
  (function () {
    fetch("https://api.github.com/repos/kerryback/academic_studio/releases/latest",
      ...
      .then(function (rel) {
        ...
        document.querySelectorAll("#as-downloads .as-dl").forEach(function (el) {
          ...
          uc.className = "as-uc";
          uc.textContent = el.textContent + " — under construction (coming soon)";
          el.replaceWith(uc);
        });
      })
