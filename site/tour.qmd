...
- **Skills** teach Claude how to do specific tasks (fetching data, building documents, following a workflow). They live in `~/.claude/skills/`.
- **Connectors** (MCP servers) give Claude access to external tools --- databases, web services, APIs. They live in `~/.claude.json`.
- **Plugins** bundle skills and connectors into one-click installs.

Browse what is available:

- [Anthropic plugins directory](https://claude.com/plugins) --- official plugins from Anthropic
- [Community plugins](https://github.com/anthropics/claude-plugins-community) --- contributed by the community
- Help → Run Setup → Additional packages --- curated packages that install with one click

The Claude menu in Academic Studio also lets you browse, create, and manage your installed skills, connectors, and memory files.
